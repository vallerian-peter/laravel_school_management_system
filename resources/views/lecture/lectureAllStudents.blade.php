      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Contact</a>
               ...
               with font-awesome or any other icon font library -->
                                ...
                                <li class="nav-item">
                                    <a href="lectureAllStudents" class="nav-link active">
                                        <i class="nav-icon fas fa-users"></i>
                                        <p>
                                            All Students
                                            {{-- <span class="right badge badge-primary">{{ ->count() }}</span> --}}
                                        </p>
                                    </a>
                                </li>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="content-header">
                        <div class="container-fluid">
                            <div class="row mb-2">
                                <div class="col-sm-6">
                                    <h1 class="m-0"> {{ $lecture->username }} All-Students</h1>
                                </div><!-- /.col -->
                                <div class="col-sm-6">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row py-4">
                                <div class="col-md-10">
                                    <div class="card p-3">
                                        <p>
                                            This are all your students from the current course selected, which linked up with your modules, they need cooperation ao can undestand.. Chao!
                                                ...
                                                {{-- @if($students->count() != 0) --}}
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="javascript:void(0)" class="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#viewStudent{{ $student->id }}"> <i class="bi bi-eye"></i> </a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                    {{-- <tr>
