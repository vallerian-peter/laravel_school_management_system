    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="adminAllDepartments" class="nav-link active">
                <i class="far fa-circle nav-icon"></i>
              <p>
                All Departments
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"> {{ $admin->username }} | All Departments</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                    ...
                    <div class="table-responsive">
                        <div class="d-flex" style="display: flex; align-items:center; justify-content:space-between;">
                           ...
                           <div class="float-right d-flex">
                              <button type="submit" class="btn btn-primary btn-sm m-2" data-bs-toggle="modal" data-bs-target="#AdminAddDepartment">+Add Department</button>
                            </div>
                        </div>
                            ...
                            <tbody id="tbody">
                                ...
                                @foreach ($departments as $dep)
                                    <tr>
                                        ...
                                        <td>{{ $dep->name }}</td>
                                        <td>
                                          <button type="button" class="btn btn-outline-success btn-sm text-center" data-bs-target="#AdminUpdateDepartment{{ $dep->id }}" data-bs-toggle="modal"> <i class="bi bi-pencil"></i> </button> 
                                          <a href="{{ route('admin.delete.department', $dep->id) }}" class="btn btn-outline-danger btn-sm text-center"> <i class="bi bi-trash"></i> </a>
                                        </td>
                                    </tr>
                                @endforeach
                        ...
                        <div class="d-flex" style="display: flex; align-items:center; justify-content:flex-end;">
                            <div class="box-count py-3 text-muted">
                                All Departments: <span id="countMod"> {{ $departments->count() }} </span>
                            </div>
                        </div>
                    </div>
                </div>
...
{{-- ADMIN ADD COURSE --}}
  <div class="modal fade" id="AdminAddDepartment" tabindex="-1" aria-labelledby="AdminAddDepartmentLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header" style="display:flex; align-items:center;">
          <div class="left" style="display: flex; flex-direction: column;">
            <h1 class="modal-title fs-5" id="AdminAddDepartmentLabel">Admin | Add-Department</h1>
          </div>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <form action="AdminAddDepartment" method="POST">
                @csrf
                <div class="mb-3">
                    <label for="text" class="form-label">Department Name</label>
                    <input type="text" id="text" name="name" class="form-control" placeholder="Department Name">
                    <span class="text-danger"> @error('name') {{ $message }} @enderror </span>
                </div>
                
                <div class="text-center w-100 py-3">
                    <button type="submit" class="btn btn-dark w-50 text-center">Add Department</button>
                </div>
